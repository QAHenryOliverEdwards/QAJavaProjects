...
public class Numbers {
    ...
    public double sumIndividualParts(double num1) {
        String numberAsString = String.valueOf(num1);
        String firstNum = String.valueOf(numberAsString.charAt(0));
        String secondNum = String.valueOf(numberAsString.charAt(1));
